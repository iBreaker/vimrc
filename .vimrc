...
" Formatting {
    ...
    autocmd FileType c,cpp,java,go,php,javascript,puppet,python,rust,twig,xml,yml,perl,sql autocmd BufWritePre <buffer> if !exists('g:breaker_keep_trailing_whitespace') | call StripTrailingWhitespace() | endif
